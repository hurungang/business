...
public class CommodityOrder implements java.io.Serializable {
	...
	private Integer deliveryToUserId;
	...
	public CommodityOrder(User user, Area area, Date dealTime, String payType,
			BigDecimal freight, Integer deliveryToUserId,
			String deliveryAddress, Date deliveryTime, String deliveryman,
			String postcode, String contact, String contactPhone,
			Date updateTime, String status, String remark, String orderType,
			Date planDeliveryTime, String memo, String comment,
			Set<PointLog> pointLogs, Set<CommodityPayment> commodityPayments,
		...
		this.deliveryToUserId = deliveryToUserId;
	...
	public Integer getDeliveryToUserId() {
		return this.deliveryToUserId;
	}

	public void setDeliveryToUserId(Integer deliveryToUserId) {
		this.deliveryToUserId = deliveryToUserId;
	}
