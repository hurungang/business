...
public class SystemCode implements java.io.Serializable {
	...
	public SystemCode(String code, String name, String category, Integer priority, Date updateTime) {
		this.code = code;
		this.name = name;
	...
	public SystemCode(SystemCode systemCode, String code, String name, String category, Integer priority,
			Integer updater, Date updateTime, String status, String remark, Set<SystemCode> systemCodes) {
