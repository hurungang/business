...
public class Commodity implements java.io.Serializable {
	...
	private Set<CommodityPromotion> commodityPromotions = new HashSet<CommodityPromotion>(0);
	private Set<CommodityPicture> commodityPictures = new HashSet<CommodityPicture>(0);

	public Commodity() {
	}

	public Commodity(Area area, CommodityCategory commodityCategory, String name, String shortName, String unit,
			BigDecimal quantity, Integer minimumBuy, String picturePath, String commendCode, String status,
			BigDecimal price, Integer point, Date updateTime) {
		this.area = area;
	...
	public Commodity(CommodityProvider commodityProvider, Area area, Commodity commodity,
			CommodityCategory commodityCategory, Integer commodityBaseId, String name, String shortName, String summary,
			String standard, String priceUnit, BigDecimal priceQuantity, String unit, BigDecimal quantity,
			Integer minimumBuy, String picturePath, Integer priority, String commendCode, String status,
			BigDecimal originalPrice, BigDecimal price, BigDecimal price1, BigDecimal price2, BigDecimal price3,
			BigDecimal price4, BigDecimal price5, Integer point, Integer updater, Date updateTime, String remark,
			Set<LabelCommodity> labelCommodities, Set<Commodity> commodities, Set<CommodityComment> commodityComments,
			Set<CommodityOrderItem> commodityOrderItems, Set<CommodityPromotion> commodityPromotions,
	...
	public void setCommodityPromotions(Set<CommodityPromotion> commodityPromotions) {
		this.commodityPromotions = commodityPromotions;
	}
