...
public class CommodityPromotion implements java.io.Serializable {
	...
	public CommodityPromotion(Commodity commodity, String typeCode,
			String typeTitle, String specialFlag, String title,
			String description, BigDecimal price, Integer minOrderCount,
			Integer currentOrderCount, Integer maxOrderCount,
			Integer maxIndividualOrderCount, String userType,
			Integer userLevel, String additionalCondition, Date startTime,
			Date endTime, String regulationCode, String status,
			Integer priority, String remark,
