...
//      g.drawImage(img, 25, 55,60,50, null);  
     ...
     * @throws IOException 
     */  
    public static void qrCodeEncode(String encodeddata, OutputStream output) throws IOException {  
        Qrcode qrcode = new Qrcode();  
        qrcode.setQrcodeErrorCorrect('M');  // 纠错级别（L 7%、M 15%、Q 25%、H 30%）和版本有关  
        qrcode.setQrcodeEncodeMode('B');      
        qrcode.setQrcodeVersion(7);     // 设置Qrcode包的版本  
    ...
    public static void main(String[] args) {  
        ...
        // 二维码内容 
        String encodeddata = "http://192.168.1.112/service/front/test.html";  
        try {  
