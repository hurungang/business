...
public class CommodityCategoryForm extends CommodityCategory implements
	...
	private List<CommodityCategoryForm> getAllSubCategoryList(
		...
		if(rootCategory!=null){
			...
			for (CommodityCategory element : rootCategory.getCommodityCategories()) {
				if(Constant.STATUS_ENABLED.equals(element.getStatus())){
					list.addAll(getAllSubCategoryList(element,prefix+prefix));
				}
			}
		}
		return list;
