 ...
 * </p>
 * 
 * @version $Id: UploadResponse.java,v 1.1 2010/05/02 02:50:07 runtechcvs Exp $
 */
public class UploadResponse {
	...
	private String ckEditorFuncNum = null;
	...
	public UploadResponse(Object... arguments) {
		...
		if(parameters.length==4){
			this.customMessage = (String) parameters[3];
		}
	}
	...
	private String getCKEditorFuncNum(){
	...
	public String toString() {
		...
		if(this.ckEditorFuncNum!=null){
			...
			sb.append(this.ckEditorFuncNum+",'"+this.url+"','"+this.customMessage+"'");
			sb.append(");\n");
		}else{
