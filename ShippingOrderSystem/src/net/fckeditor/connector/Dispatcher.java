 ...
 * 
 * @version $Id: Dispatcher.java,v 1.1 2010/05/02 02:49:18 runtechcvs Exp $
 */
public class Dispatcher {
	...
	UploadResponse doPost(final HttpServletRequest request) {
		...
		uploadResponse.setCKEditorFuncNum(context.getCkEditorFuncNum());
	...
	public Object getServletContext() {
		...
		return this.connector.getServletContext();
	}
