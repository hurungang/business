...
public class ConsignmentJson extends Consignment implements ModelJson {

	private Integer[] ids;
	
	public ConsignmentJson() {
		super();
		// TODO Auto-generated constructor stub
	}
	
	public ConsignmentJson(Object model) throws ModelException {
		this.copyFrom(model);
	}
	...
	public Object getModel() throws ModelException {
		// TODO Auto-generated method stub
		try {
			Consignment model = new Consignment();
	...
	public Map toMap(){
		try {
			return BeanUtil.toMap(this.getModel(),"commodityOrders");
