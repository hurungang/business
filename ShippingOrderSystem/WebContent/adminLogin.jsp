...
<runtech:layout id="html" template="/template/login_template.jsp" errorPage="/WEB-INF/jsp/default/error.jsp">
	<runtech:layoutBody name="$BODY$">
		...
		<s:form action="adminLoginAction">
			<s:textfield cssClass="text-input medium-input" id="userName" name="userName" value="admin" label="%{getText('label.login.userName')}"/>
			<s:password cssClass="text-input medium-input" id="userPassword" name="userPassword" value="bgpass0000" label="%{getText('label.login.userPassword')}"/>
