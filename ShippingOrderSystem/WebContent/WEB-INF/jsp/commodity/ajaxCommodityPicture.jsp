...
<s:form name="ajaxListForm" id="ajaxListForm" cssClass="ajaxForm" action="ajax/ajaxCommodityPicture" >
	...
	<s:form name="ajaxUpdateForm" id="ajaxUpdateForm" cssClass="ajaxForm" enctype="multipart/form-data" action="ajax/ajaxCommodityPicture" >
	<s:hidden name="formId"></s:hidden>
	<s:hidden name="pageCode"></s:hidden>
	<s:file name="uploadPicture.picture" label="%{getText('text.picture.path')}" size="60"></s:file>
	<s:textfield name="uploadPicture.description" label="%{getText('text.picture.description')}" size="60"></s:textfield>
