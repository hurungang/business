...
<%@ taglib prefix="s" uri="/struts-tags" %>
			...
			<noscript>&lt;!-- Show a notification if the user has
				disabled javascript --&gt; &lt;div class="notification error
				png_bg"&gt; &lt;div&gt; Javascript is disabled or is not supported
				by your browser. Please &lt;a href="http://browsehappy.com/"
				title="Upgrade to a better browser"&gt;upgrade&lt;/a&gt; your
				browser or &lt;a
				href="http://www.google.com/support/bin/answer.py?answer=23852"
				title="Enable Javascript in your browser"&gt;enable&lt;/a&gt;
				Javascript to navigate the interface properly. &lt;/div&gt;
				&lt;/div&gt;
			</noscript>
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button"
					href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"><span>
							<img src="images/pencil_48.png" alt="icon"><br> Write
									an Article 
					</span></a></li>
				...
				<li><a class="shortcut-button"
					href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"><span>
							<img src="images/clock_48.png" alt="icon"><br> Add an
									Event 
					</span></a></li>

				<li><a class="shortcut-button"
					href="http://demo.ponjoh.com/Simpla-Admin/index.html?#messages"
					rel="modal"><span> <img src="images/comment_48.png"
							alt="icon"><br> Open Modal </span></a></li>
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					...
					<ul class="content-box-tabs">
						<li><a
							href="#tab1"
							class="default-tab current">Table</a></li>
						<!-- href must be unique and match the id of target div -->
						<li><a
							href="#tab2">Forms</a></li>
					</ul>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" id="tab1"
						...
						<div class="notification attention png_bg">
							<a href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
								class="close"><b></b></a>
						...
						<table>
									...
									<td colspan="6">
										<div class="bulk-actions align-left">
											<select name="dropdown">
												...
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#">Apply
												to selected</a>
										</div>

										<div class="pagination">
											<a href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
												title="First Page">« First</a><a
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
												title="Previous Page">« Previous</a> <a
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
												class="number" title="1">1</a> <a
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
												class="number" title="2">2</a> <a
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
												class="number current" title="3">3</a> <a
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
												class="number" title="4">4</a> <a
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
												title="Next Page">Next »</a><a
												href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
							...
							<tbody>
								<tr class="alt-row">
									...
									<td><a
										href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
										title="title">Sit amet</a></td>
									<td>Consectetur adipiscing</td>
									<td>Donec tortor diam</td>
									<td>
										<!-- Icons -->  <a
										href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
										title="Edit"><b class="edit"></b></a>
										<a href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
										title="Delete"><b class="delete"></b></a>
										<a href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
										title="Edit Meta"><b class="editMeta"></b></a>
									</td>
								</tr>
							...
							<fieldset>
								...
								<p>
									<label>Small form input</label> <input
										...
										class="input-notification success png_bg">Successful
											message</span> <!-- Classes for input-notification: success, error, information, attention -->
								...
								<p>
									<label>Checkboxes</label> <input type="checkbox"
										name="checkbox1"> This is a checkbox <input
										type="checkbox" name="checkbox2"> And this is another
											checkbox 
								</p>

								<p>
									<label>Radio buttons</label> <input type="radio" name="radio1">
										This is a radio button<br> <input type="radio"
											name="radio2"> This is another radio button 
								</p>
								...
								<p>
									...
									<div style="width: 653px;" class="wysiwyg">
										...
										<iframe style="min-height: 250px; width: 645px; "
											id="textareaIFrame"></iframe>
									</div>
									<textarea class="text-input textarea wysiwyg" id="textarea"
										name="textfield" cols="79" rows="15" style="display: none;"></textarea>
								</p>
			...
			<div class="notification attention png_bg">
				<a href="http://demo.ponjoh.com/Simpla-Admin/index.html?#"
					class="close"><img src="images/cross_grey_small.png"
			...
			<div id="footer">
				<small> <!-- Remove this notice or replace it with whatever you want -->
					...
					href="http://themeforest.net/item/simpla-admin-flexible-user-friendly-admin-skin/46073">Simpla
						Admin</a> | <a href="http://demo.ponjoh.com/Simpla-Admin/index.html?#">Top</a>
				</small>
			</div>
			<!-- End #footer -->
